          ...
          <div className="flex flex-col gap-9 sm:gap-12 max-w-3xl mx-auto px-4 sm:px-7 py-11 md:py-20">
            <div className="flex flex-col gap-4">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[32px]">
                Hey there. Saya Ilman — Website Developer asal Kabupaten Bekasi,
                saat ini fokus sebagai{" "}
                <span className="bg-[linear-gradient(90deg,_rgba(243,202,77,0.4)_0%,_rgba(243,202,77,0.05)_100%)]">
                  freelance website developer, konten kreator sekaligus streamer
                </span>{" "}
                di <span className="border-b-2">Youtube</span>
              </h2>
